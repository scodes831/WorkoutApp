...
public class HIITMenu extends SubMenu {
	...
	public void processSelection(Workout workout, UserManager userManager, MainMenu mainMenu, WorkoutMenu workoutMenu,
		...
		HIIT hiit = (HIIT) exercise;
		switch (selection) {
		case 1:
			hiit.displayHIITExercises();
			break;
		case 2:
			hiit.displayHIITExercises();
			hiit.editHIITDetails(connection, workout, exerciseTable, hiitTable);
			break;
		case 3:
