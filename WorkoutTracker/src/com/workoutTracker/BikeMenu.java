...
public class BikeMenu extends SubMenu {
	...
	public void processSelection(Workout workout, UserManager userManager, MainMenu mainMenu, WorkoutMenu workoutMenu,
		...
		Bike bike = (Bike) exercise;
		switch (selection) {
		case 1:
			bike.displayBikeExercises();
			break;
		case 2:
			bike.displayBikeExercises();
			bike.editBikeDetails(connection, workout, exerciseTable, bikeTable);
			break;
		case 3:
